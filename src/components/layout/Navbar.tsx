        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          ...
          <Link to="/" className="flex items-center gap-3 group">
            ...
            <div className="flex flex-col">
              <span className="font-black text-lg leading-none uppercase font-display tracking-tight text-white group-hover:text-gold-400 transition-colors">
          ...
          <div className="hidden sm:flex items-center gap-3">
            <button
              ...
              className="flex items-center gap-1.5 px-3.5 py-2 rounded-lg text-xs font-black uppercase tracking-wider text-gold-400 hover:text-white hover:bg-navy-800 transition-colors border border-gold-500/40"
            >
